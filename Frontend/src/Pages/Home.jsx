...
const features = [
  ...
  { icon: "⚡", label: "Real-time", desc: "Socket.io multiplayer" },
...
export default function Home() {
  ...
  const theme = {
    ...
    cardBorder: dark ? "rgba(255,255,255,0.08)" : "rgba(99,102,241,0.15)",
    ...
    orb3: dark ? "rgba(59,130,246,0.08)" : "rgba(59,130,246,0.1)",
  ...
  const btnPrimary = {
    ...
    shadow: dark ? "0 0 40px rgba(99,102,241,0.4)" : "0 8px 32px rgba(99,102,241,0.35)",
  };

  const btnSecondary = {
    bg: dark ? "rgba(255,255,255,0.06)" : "rgba(99,102,241,0.08)",
    border: dark ? "rgba(255,255,255,0.12)" : "rgba(99,102,241,0.2)",
    color: dark ? "rgba(255,255,255,0.85)" : "#3730a3",
  };
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          style={{
            ...
            background: theme.orb1, filter: "blur(80px)",
          }}
        />
        <motion.div
          ...
          style={{
            ...
            background: theme.orb2, filter: "blur(80px)",
          }}
        />
        <motion.div
          ...
          style={{
            ...
            background: theme.orb3, filter: "blur(60px)",
          }}
        />
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center text-center">
        ...
        <motion.p
          ...
          style={{
            fontSize: 16, lineHeight: 1.6, marginBottom: 40,
            color: theme.textSub,
            transition: "color 0.4s ease",
            maxWidth: 340,
          }}
        >
          Bargain with an AI shopkeeper. Outsmart it.
          Climb the leaderboard. How low can you go?
        </motion.p>
        ...
        >
          {/* Start Game */}
          <motion.button
            whileHover={{ scale: 1.03, boxShadow: btnPrimary.shadow }}
            whileTap={{ scale: 0.97 }}
            onHoverStart={() => setHovered("game")}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onHoverStart={() => setHovered("lb")}
            onHoverEnd={() => setHovered(null)}
            onClick={() => navigate("/leaderboard")}
            style={{
              padding: "16px 24px",
              borderRadius: 16,
              background: btnSecondary.bg,
              border: `1px solid ${btnSecondary.border}`,
          ...
          >
            ...
            Leaderboard
            <motion.span
              animate={{ x: hovered === "lb" ? 4 : 0 }}
              transition={{ type: "spring", stiffness: 400 }}
              style={{ marginLeft: "auto", opacity: 0.5, fontSize: 16 }}
            >
              →
            </motion.span>
          </motion.button>
          ...
          {features.map((f, i) => (
            <motion.div
              ...
              style={{
                padding: "14px 10px",
                borderRadius: 14,
                background: theme.featBg,
                border: `1px solid ${theme.featBorder}`,
                textAlign: "center",
            ...
            >
              ...
              <div style={{ fontSize: 12, fontWeight: 700, color: theme.text, marginBottom: 2, transition: "color 0.4s" }}>
                {f.label}
              </div>
              <div style={{ fontSize: 10, color: theme.featText, transition: "color 0.4s" }}>
                {f.desc}
              </div>
            </motion.div>
          ))}
        ...
        >
          Offer below ₹700 and the deal is off. You've been warned.
        </motion.p>
